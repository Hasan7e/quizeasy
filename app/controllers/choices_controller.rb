class ChoicesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @choice.update(choice_params)
        format.html { redirect_to @choice, notice: "Choice was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to choices_path, notice: "Choice was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_choice
      @choice = Choice.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def choice_params
      params.expect(choice: [ :question_id, :body, :correct ])
    end
end
